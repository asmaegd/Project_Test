					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white bg-danger o-hidden h-100">
							<div class="card-body">
								...
								<div class="mr-5">
									<a class="navbar-brand mr-1 text-white" href="Admin_Order.jsp">Commandes
										non traitée</a>
								</div>
							</div>
							...
							<div class="card-body">
								...
								<div class="mr-5">
									<a class="navbar-brand mr-1 text-white"
										href="Admin_Livraison.jsp">Livraison</a>
								</div>
							</div>
							<div class="card-footer text-white clearfix small z-1">
								<span class="float-left"></span>
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white  bg-warning o-hidden h-100">
							<div class="card-body">
								...
								<div class="mr-5">
									<a class="navbar-brand mr-1 text-white"
										href="Admin_Historique.jsp">Historique</a>
								</div>
							</div>
							<div class="card-footer text-white clearfix small z-1">
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white bg-info  o-hidden h-100">
							<div class="card-body">
								...
								<div class="mr-5">
									<a class="navbar-brand mr-1 text-white" href="Admin_Inbox.jsp">Message</a>
								</div>
							</div>
							<div class="card-footer text-white clearfix small z-1">
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white bg-primary o-hidden h-100">
							<div class="card-body">
								...
								<div class="mr-5">
									<a class="navbar-brand mr-1 text-white"
										href="Admin_Statistique.jsp">Statistique</a>
								</div>
							</div>
							<div class="card-footer text-white clearfix small z-1">
								<span class="float-left">
