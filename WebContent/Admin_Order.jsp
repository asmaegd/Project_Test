		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="EspaceAdmin.jsp">Tableau
							de bord</a></li>
					<li class="breadcrumb-item active">Commandes non traitée</li>
				</ol>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i> Tableau des Commandes non traitée
				</div>
				<div class="card-body">
					<div class="card-body">
							...
							<table class="table table-bordered" id="dataTable" width="100%"
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<%
											ArrayList<String> liste_nom_repas = e.getRepas(listeCommande.get(i).getId());
											for (int j = 0; j < liste_nom_repas.size(); j++) {
											%> <%=liste_nom_repas.get(j)%><br> <%
 }
 %>
										</td>
										<td><%=listeCommande.get(i).getDate_commande()%></td>

										<td>&nbsp &nbsp &nbsp <input type="radio" value="1"
											class="form-check-input"
											name="choix<%=listeCommande.get(i).getId()%>">Accepter
											&nbsp &nbsp &nbsp &nbsp <input type="radio"
											class="form-check-input" value="0"
											name="choix<%=listeCommande.get(i).getId()%>">Refuser
										</td>
									</tr>
									<%
									}
