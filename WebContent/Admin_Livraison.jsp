		...
		<div id="content-wrapper">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i> Tableau des Commandes à livrér
				</div>
				<div class="card-body">
					<div class="card-body">
						<form action="AdminLivraisonServlet" method="post">
							<table class="table table-bordered" id="dataTable" width="100%"
								...
								<thead>
									<tr>
										...
										<th scope="col">Livreur Disponible</th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td><select class="form-select" name="livreurDispo">
												<%
												ArrayList<Livreur> listeLivreurDispo = e.getLivreurDispo(0);
												for (int j = 0; j < listeLivreurDispo.size(); j++) {
												%>
												<option value="<%=listeLivreurDispo.get(j).getId()%>"><%=listeLivreurDispo.get(j).getNom() + " " + listeLivreurDispo.get(j).getPrenom()%></option>
