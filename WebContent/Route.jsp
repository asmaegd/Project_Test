      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Commande en route</li>
          </ol>
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>
              Tableau des commandes en route
             </div>
            <div class="card-body">
              <div class="table-responsive">
              <form action="CmdAttServlet" method="post"> 
					   ...
					   for(int i = 0; i < listeCommande.size(); i++)
					   {
						    ...
						    <tr>
						      ...
						      <td> <%= listeCommande.get(i).getDate_commande() %></td>
		      				   ...
		      				   <td> 
		      				  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="4" class="form-check-input" name="choix<%= listeCommande.get(i).getId() %>">Livré
		      				  </td> 
			               </tr>
		      				<%
		      			}
