		...
		<div id="content-wrapper">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-table"></i> Tableau des Commandes
				</div>
				<div class="card-body">
					<div class="card-body">
						...
						<form action="HistoriqueServlet" method="post">
							...
							<div class="row mb-3">
								<div class="col">
									...
									<select class="form-control" name="status">
										...
										<option value="2">Livraison en attente</option>
										<option value="3">Livraison en route</option>
						...
						<table class="table table-bordered" width="100%">
							<thead>
								<tr>
									<th class="table-primary" scope="col">Commande</th>
									<th class="table-primary" scope="col">Nom</th>
									<th class="table-primary" scope="col">Addresse</th>
									<th class="table-primary" scope="col">Telephone_client</th>
									<th class="table-primary" scope="col">Date</th>
									
									<th class="table-danger" scope="col">Livreur</th>
									<th class="table-danger" scope="col">Telephone_livreur</th>
								</tr>
							</thead>
							<tbody>
								<%
								...
								if (status != null) {
									...
									ArrayList<Commande> liste = (ArrayList<Commande>) request.getAttribute("listeCommandeHistorique");

									for (int i = 0; i < liste.size(); i++) {
								%>
								<tr>
									<th scope="row"><%=liste.get(i).getId()%></th>
									<td><%=liste.get(i).getNom_client()%></td>
									<td><%=liste.get(i).getAdresse()%></td>
									<td><%=liste.get(i).getTele_client()%></td>
									<td><%=liste.get(i).getDate_commande()%></td>
							
									<td><%=liste.get(i).getNom_livreur()%></td>
									<td><%=liste.get(i).getTele_livreur()%></td>
